...
with st.sidebar:
    ...
    4. **Descarga** las gráficas y el Excel
    """)
    st.markdown("---")
...
if uploaded_file is not None:
    ...
    try:
        ...
        st.info("Por favor verifica que el archivo CSV tenga el formato correcto.")
    ...
    - **Columna D (índice 3):** ID del cliente
    - **Columna E (índice 4):** Nombre del cliente
    - **Columna L (índice 11):** Tipo asesor
    - **Columna N (índice 13):** Departamento
    - **Columna S (índice 18):** Familia
    - **Columna W (índice 22):** Área
    """)